...
const buttonVariants = cva(
  `inline-flex items-center justify-center whitespace-nowrap w-fit rounded-full text-sm font-medium ring-offset-light transition-all
    ...
    disabled:pointer-events-none disabled:opacity-50 relative`,
  {
    variants: {
      variant: {
        secondary: "bg-transparent text-light outline outline-light outline-px",
        primary:
